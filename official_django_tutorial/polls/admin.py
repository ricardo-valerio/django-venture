...
second argument to admin.site.register() – any time you need to change the admin
 options for an object.
"""


# With TabularInline (instead of StackedInline), the related objects
...
class QuestionAdmin(admin.ModelAdmin):
    ...
    # the scenes, limiting the number of search fields to a reasonable number
    # will make it easier for your database to do the search.
